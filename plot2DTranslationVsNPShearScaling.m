%   Plots and saves 2D Plots, comparing Translation with non-parabolic
%   Scaled Shearing
%
...
ylabel('$s = \frac{y}{x}$','Interpreter','latex')
...
axis square, 
axis xy
plotTickLatex2D('fontsize',22,'xlabeldy',.032,'ylabeldx',.02);
...
% save to EPS-File
SaveAsEps(1,'ScaleShear_im');
SaveAsEps(2,'ScaleShear_dom');